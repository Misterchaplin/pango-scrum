...
public class VSprint {
	...
	protected void createContents() {
	    ...
	    Composite composite_1 = new Composite(sashGroupAction, SWT.NONE);
	    composite_1.setBackground(SWTResourceManager.getColor(SWT.COLOR_LIST_BACKGROUND));
	      
	    Group grpAjouterUnSprint = new Group(composite_1, SWT.SHADOW_OUT);
	    grpAjouterUnSprint.setLocation(384, 0);
	    grpAjouterUnSprint.setSize(392, 243);
	    ...
	    Button btnAnnuler = new Button(grpAjouterUnSprint, SWT.NONE);
	    ...
	    Label lblInfoTraitement = new Label(composite_1, SWT.NONE);
